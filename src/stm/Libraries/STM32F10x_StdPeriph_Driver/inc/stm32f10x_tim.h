...
#define IS_TIM_ALL_PERIPH(PERIPH)                                                                  \
  (((*(uint32_t *)&(PERIPH)) == TIM1_BASE) || ((*(uint32_t *)&(PERIPH)) == TIM2_BASE) ||           \
   ((*(uint32_t *)&(PERIPH)) == TIM3_BASE) || ((*(uint32_t *)&(PERIPH)) == TIM4_BASE) ||           \
   ((*(uint32_t *)&(PERIPH)) == TIM5_BASE) || ((*(uint32_t *)&(PERIPH)) == TIM6_BASE) ||           \
   ((*(uint32_t *)&(PERIPH)) == TIM7_BASE) || ((*(uint32_t *)&(PERIPH)) == TIM8_BASE))
...
#define IS_TIM_OCM(MODE)                                                                           \
  (((MODE) == TIM_OCMode_Timing) || ((MODE) == TIM_OCMode_Active) ||                               \
   ((MODE) == TIM_OCMode_Inactive) || ((MODE) == TIM_OCMode_Toggle) ||                             \
   ((MODE) == TIM_OCMode_PWM1) || ((MODE) == TIM_OCMode_PWM2) ||                                   \
   ((MODE) == TIM_ForcedAction_Active) || ((MODE) == TIM_ForcedAction_InActive))
/**
  * @}
  */
...
#define IS_TIM_CKD_DIV(DIV)                                                                        \
  (((DIV) == TIM_CKD_DIV1) || ((DIV) == TIM_CKD_DIV2) || ((DIV) == TIM_CKD_DIV4))
/**
  * @}
  */
...
#define IS_TIM_AUTOMATIC_OUTPUT_STATE(STATE)                                                       \
  (((STATE) == TIM_AutomaticOutput_Enable) || ((STATE) == TIM_AutomaticOutput_Disable))
/**
  * @}
  */
...
#define IS_TIM_IC_SELECTION(SELECTION)                                                             \
  (((SELECTION) == TIM_ICSelection_DirectTI) || ((SELECTION) == TIM_ICSelection_IndirectTI) ||     \
...
#define IS_TIM_DMA_BASE(BASE)                                                                      \
  (((BASE) == TIM_DMABase_CR1) || ((BASE) == TIM_DMABase_CR2) || ((BASE) == TIM_DMABase_SMCR) ||   \
   ((BASE) == TIM_DMABase_DIER) || ((BASE) == TIM_DMABase_SR) || ((BASE) == TIM_DMABase_EGR) ||    \
   ((BASE) == TIM_DMABase_CCMR1) || ((BASE) == TIM_DMABase_CCMR2) ||                               \
   ((BASE) == TIM_DMABase_CCER) || ((BASE) == TIM_DMABase_CNT) || ((BASE) == TIM_DMABase_PSC) ||   \
   ((BASE) == TIM_DMABase_ARR) || ((BASE) == TIM_DMABase_RCR) || ((BASE) == TIM_DMABase_CCR1) ||   \
   ((BASE) == TIM_DMABase_CCR2) || ((BASE) == TIM_DMABase_CCR3) || ((BASE) == TIM_DMABase_CCR4) || \
   ((BASE) == TIM_DMABase_BDTR) || ((BASE) == TIM_DMABase_DCR))
/**
  * @}
  */
...
#define IS_TIM_DMA_LENGTH(LENGTH)                                                                  \
  (((LENGTH) == TIM_DMABurstLength_1Byte) || ((LENGTH) == TIM_DMABurstLength_2Bytes) ||            \
   ((LENGTH) == TIM_DMABurstLength_3Bytes) || ((LENGTH) == TIM_DMABurstLength_4Bytes) ||           \
   ((LENGTH) == TIM_DMABurstLength_5Bytes) || ((LENGTH) == TIM_DMABurstLength_6Bytes) ||           \
   ((LENGTH) == TIM_DMABurstLength_7Bytes) || ((LENGTH) == TIM_DMABurstLength_8Bytes) ||           \
   ((LENGTH) == TIM_DMABurstLength_9Bytes) || ((LENGTH) == TIM_DMABurstLength_10Bytes) ||          \
   ((LENGTH) == TIM_DMABurstLength_11Bytes) || ((LENGTH) == TIM_DMABurstLength_12Bytes) ||         \
   ((LENGTH) == TIM_DMABurstLength_13Bytes) || ((LENGTH) == TIM_DMABurstLength_14Bytes) ||         \
   ((LENGTH) == TIM_DMABurstLength_15Bytes) || ((LENGTH) == TIM_DMABurstLength_16Bytes) ||         \
   ((LENGTH) == TIM_DMABurstLength_17Bytes) || ((LENGTH) == TIM_DMABurstLength_18Bytes))
/**
  * @}
  */
...
#define IS_TIM_EXT_PRESCALER(PRESCALER)                                                            \
  (((PRESCALER) == TIM_ExtTRGPSC_OFF) || ((PRESCALER) == TIM_ExtTRGPSC_DIV2) ||                    \
...
#define IS_TIM_TRIGGER_SELECTION(SELECTION)                                                        \
  (((SELECTION) == TIM_TS_ITR0) || ((SELECTION) == TIM_TS_ITR1) || ((SELECTION) == TIM_TS_ITR2) || \
   ((SELECTION) == TIM_TS_ITR3) || ((SELECTION) == TIM_TS_TI1F_ED) ||                              \
   ((SELECTION) == TIM_TS_TI1FP1) || ((SELECTION) == TIM_TS_TI2FP2) ||                             \
...
#define IS_TIM_TIXCLK_SOURCE(SOURCE)                                                               \
  (((SOURCE) == TIM_TIxExternalCLK1Source_TI1) || ((SOURCE) == TIM_TIxExternalCLK1Source_TI2) ||   \
...
#define IS_TIM_UPDATE_SOURCE(SOURCE)                                                               \
  (((SOURCE) == TIM_UpdateSource_Global) || ((SOURCE) == TIM_UpdateSource_Regular))
/**
  * @}
  */
...
#define IS_TIM_TRGO_SOURCE(SOURCE)                                                                 \
  (((SOURCE) == TIM_TRGOSource_Reset) || ((SOURCE) == TIM_TRGOSource_Enable) ||                    \
   ((SOURCE) == TIM_TRGOSource_Update) || ((SOURCE) == TIM_TRGOSource_OC1) ||                      \
   ((SOURCE) == TIM_TRGOSource_OC1Ref) || ((SOURCE) == TIM_TRGOSource_OC2Ref) ||                   \
...
#define IS_TIM_MSM_STATE(STATE)                                                                    \
  (((STATE) == TIM_MasterSlaveMode_Enable) || ((STATE) == TIM_MasterSlaveMode_Disable))
/**
  * @}
  */
...
#define IS_TIM_GET_FLAG(FLAG)                                                                      \
  (((FLAG) == TIM_FLAG_Update) || ((FLAG) == TIM_FLAG_CC1) || ((FLAG) == TIM_FLAG_CC2) ||          \
   ((FLAG) == TIM_FLAG_CC3) || ((FLAG) == TIM_FLAG_CC4) || ((FLAG) == TIM_FLAG_COM) ||             \
   ((FLAG) == TIM_FLAG_Trigger) || ((FLAG) == TIM_FLAG_Break) || ((FLAG) == TIM_FLAG_CC1OF) ||     \
