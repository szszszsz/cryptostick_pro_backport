...
#define IS_I2C_ALL_PERIPH(PERIPH)                                                                  \
  (((*(uint32_t *)&(PERIPH)) == I2C1_BASE) || ((*(uint32_t *)&(PERIPH)) == I2C2_BASE))
/** @defgroup I2C_modes
  * @{
  */
...
#define IS_I2C_DIRECTION(DIRECTION)                                                                \
  (((DIRECTION) == I2C_Direction_Transmitter) || ((DIRECTION) == I2C_Direction_Receiver))
/**
  * @}
  */
...
#define IS_I2C_ACKNOWLEDGE_ADDRESS(ADDRESS)                                                        \
  (((ADDRESS) == I2C_AcknowledgedAddress_7bit) || ((ADDRESS) == I2C_AcknowledgedAddress_10bit))
/**
  * @}
  */
...
#define IS_I2C_GET_IT(IT)                                                                          \
  (((IT) == I2C_IT_SMBALERT) || ((IT) == I2C_IT_TIMEOUT) || ((IT) == I2C_IT_PECERR) ||             \
   ((IT) == I2C_IT_OVR) || ((IT) == I2C_IT_AF) || ((IT) == I2C_IT_ARLO) ||                         \
   ((IT) == I2C_IT_BERR) || ((IT) == I2C_IT_TXE) || ((IT) == I2C_IT_RXNE) ||                       \
   ((IT) == I2C_IT_STOPF) || ((IT) == I2C_IT_ADD10) || ((IT) == I2C_IT_BTF) ||                     \
...
#define IS_I2C_GET_FLAG(FLAG)                                                                      \
  (((FLAG) == I2C_FLAG_DUALF) || ((FLAG) == I2C_FLAG_SMBHOST) ||                                   \
   ((FLAG) == I2C_FLAG_SMBDEFAULT) || ((FLAG) == I2C_FLAG_GENCALL) || ((FLAG) == I2C_FLAG_TRA) ||  \
   ((FLAG) == I2C_FLAG_BUSY) || ((FLAG) == I2C_FLAG_MSL) || ((FLAG) == I2C_FLAG_SMBALERT) ||       \
   ((FLAG) == I2C_FLAG_TIMEOUT) || ((FLAG) == I2C_FLAG_PECERR) || ((FLAG) == I2C_FLAG_OVR) ||      \
   ((FLAG) == I2C_FLAG_AF) || ((FLAG) == I2C_FLAG_ARLO) || ((FLAG) == I2C_FLAG_BERR) ||            \
   ((FLAG) == I2C_FLAG_TXE) || ((FLAG) == I2C_FLAG_RXNE) || ((FLAG) == I2C_FLAG_STOPF) ||          \
   ((FLAG) == I2C_FLAG_ADD10) || ((FLAG) == I2C_FLAG_BTF) || ((FLAG) == I2C_FLAG_ADDR) ||          \
   ((FLAG) == I2C_FLAG_SB))
/**
  * @}
  */
...
#define IS_I2C_EVENT(EVENT)                                                                        \
  (((EVENT) == I2C_EVENT_SLAVE_TRANSMITTER_ADDRESS_MATCHED) ||                                     \
   ...
   ((EVENT) == I2C_EVENT_SLAVE_STOP_DETECTED) || ((EVENT) == I2C_EVENT_MASTER_MODE_SELECT) ||      \
   ((EVENT) == I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED) ||                                      \
   ((EVENT) == I2C_EVENT_MASTER_RECEIVER_MODE_SELECTED) ||                                         \
   ((EVENT) == I2C_EVENT_MASTER_BYTE_RECEIVED) ||                                                  \
   ((EVENT) == I2C_EVENT_MASTER_BYTE_TRANSMITTED) ||                                               \
   ((EVENT) == I2C_EVENT_MASTER_BYTE_TRANSMITTING) ||                                              \
   ((EVENT) == I2C_EVENT_MASTER_MODE_ADDRESS10) || ((EVENT) == I2C_EVENT_SLAVE_ACK_FAILURE))
/**
  * @}
  */
