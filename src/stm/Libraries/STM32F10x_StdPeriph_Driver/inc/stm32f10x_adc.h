...
#define IS_ADC_ALL_PERIPH(PERIPH)                                                                  \
  (((*(uint32_t *)&(PERIPH)) == ADC1_BASE) || ((*(uint32_t *)&(PERIPH)) == ADC2_BASE) ||           \
   ((*(uint32_t *)&(PERIPH)) == ADC3_BASE))

#define IS_ADC_DMA_PERIPH(PERIPH)                                                                  \
  (((*(uint32_t *)&(PERIPH)) == ADC1_BASE) || ((*(uint32_t *)&(PERIPH)) == ADC3_BASE))
...
#define IS_ADC_MODE(MODE)                                                                          \
  (((MODE) == ADC_Mode_Independent) || ((MODE) == ADC_Mode_RegInjecSimult) ||                      \
   ((MODE) == ADC_Mode_RegSimult_AlterTrig) || ((MODE) == ADC_Mode_InjecSimult_FastInterl) ||      \
   ((MODE) == ADC_Mode_InjecSimult_SlowInterl) || ((MODE) == ADC_Mode_InjecSimult) ||              \
   ((MODE) == ADC_Mode_RegSimult) || ((MODE) == ADC_Mode_FastInterl) ||                            \
   ((MODE) == ADC_Mode_SlowInterl) || ((MODE) == ADC_Mode_AlterTrig))
/**
  * @}
  */
...
#define IS_ADC_EXT_TRIG(REGTRIG)                                                                   \
  (((REGTRIG) == ADC_ExternalTrigConv_T1_CC1) || ((REGTRIG) == ADC_ExternalTrigConv_T1_CC2) ||     \
   ...
   ((REGTRIG) == ADC_ExternalTrigConv_None) || ((REGTRIG) == ADC_ExternalTrigConv_T3_CC1) ||       \
   ((REGTRIG) == ADC_ExternalTrigConv_T2_CC3) || ((REGTRIG) == ADC_ExternalTrigConv_T8_CC1) ||     \
   ((REGTRIG) == ADC_ExternalTrigConv_T8_TRGO) || ((REGTRIG) == ADC_ExternalTrigConv_T5_CC1) ||    \
...
#define IS_ADC_CHANNEL(CHANNEL)                                                                    \
  (((CHANNEL) == ADC_Channel_0) || ((CHANNEL) == ADC_Channel_1) || ((CHANNEL) == ADC_Channel_2) || \
   ...
   ((CHANNEL) == ADC_Channel_9) || ((CHANNEL) == ADC_Channel_10) ||                                \
...
#define IS_ADC_SAMPLE_TIME(TIME)                                                                   \
  (((TIME) == ADC_SampleTime_1Cycles5) || ((TIME) == ADC_SampleTime_7Cycles5) ||                   \
   ((TIME) == ADC_SampleTime_13Cycles5) || ((TIME) == ADC_SampleTime_28Cycles5) ||                 \
   ((TIME) == ADC_SampleTime_41Cycles5) || ((TIME) == ADC_SampleTime_55Cycles5) ||                 \
   ((TIME) == ADC_SampleTime_71Cycles5) || ((TIME) == ADC_SampleTime_239Cycles5))
/**
  * @}
  */
...
#define IS_ADC_GET_FLAG(FLAG)                                                                      \
  (((FLAG) == ADC_FLAG_AWD) || ((FLAG) == ADC_FLAG_EOC) || ((FLAG) == ADC_FLAG_JEOC) ||            \
   ((FLAG) == ADC_FLAG_JSTRT) || ((FLAG) == ADC_FLAG_STRT))
/**
  * @}
  */
