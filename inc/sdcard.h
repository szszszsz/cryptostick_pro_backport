...
typedef enum {
  ...
  SD_BLOCK_LEN_ERR =
      (10), /* Transferred block length is not allowed for the card or the number of transferred
               bytes does not match the block length */
  SD_ERASE_SEQ_ERR = (11),        /* An error in the sequence of erase command occurs.*/
  SD_BAD_ERASE_PARAM = (12),      /* An Invalid selection for erase groups */
  SD_WRITE_PROT_VIOLATION = (13), /* Attempt to program a write protect block */
  SD_LOCK_UNLOCK_FAILED =
      (14), /* Sequence or password error has been detected in unlock command or if there was an
  ...
  SD_ERASE_RESET = (25),   /* Erase sequence was cleared before executing because an out of erase
...
#define SDIO_APP_CMD ((uint8_t)55) // 0x37
...
typedef enum { SD_NO_TRANSFER = 0, SD_TRANSFER_IN_PROGRESS } SDTransferState;
