...
void SDIO_SetParam(SDIO_InitTypeDef* SDIO_InitStruct,uint32_t ClockDiv,uint32_t BusWide)
{
  ...
  SDIO_InitStructure.SDIO_ClockBypass         = SDIO_ClockBypass_Disable; // SDIO_ClockBypass_Enable;//  SDIO_ClockBypass_Disable;
...
/*
  ...
  SDIO_InitStructure.SDIO_ClockBypass         = SDIO_ClockBypass_Enable;//  SDIO_ClockBypass_Disable;
  SDIO_InitStructure.SDIO_ClockPowerSave      = SDIO_ClockPowerSave_Disable;
