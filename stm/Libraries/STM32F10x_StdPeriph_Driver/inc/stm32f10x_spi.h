...
#define IS_SPI_ALL_PERIPH(PERIPH)                                                                  \
  (((*(uint32_t *)&(PERIPH)) == SPI1_BASE) || ((*(uint32_t *)&(PERIPH)) == SPI2_BASE) ||           \
   ((*(uint32_t *)&(PERIPH)) == SPI3_BASE))
#define IS_SPI_23_PERIPH(PERIPH)                                                                   \
  (((*(uint32_t *)&(PERIPH)) == SPI2_BASE) || ((*(uint32_t *)&(PERIPH)) == SPI3_BASE))
...
#define IS_I2S_AUDIO_FREQ(FREQ)                                                                    \
  (((FREQ) == I2S_AudioFreq_48k) || ((FREQ) == I2S_AudioFreq_44k) ||                               \
   ((FREQ) == I2S_AudioFreq_22k) || ((FREQ) == I2S_AudioFreq_16k) ||                               \
   ((FREQ) == I2S_AudioFreq_8k) || ((FREQ) == I2S_AudioFreq_Default))
/**
  * @}
  */
...
#define IS_SPI_I2S_CONFIG_IT(IT)                                                                   \
  (((IT) == SPI_I2S_IT_TXE) || ((IT) == SPI_I2S_IT_RXNE) || ((IT) == SPI_I2S_IT_ERR))
...
#define IS_SPI_I2S_GET_IT(IT)                                                                      \
  (((IT) == SPI_I2S_IT_RXNE) || ((IT) == SPI_I2S_IT_TXE) || ((IT) == I2S_IT_UDR) ||                \
   ((IT) == SPI_IT_CRCERR) || ((IT) == SPI_IT_MODF) || ((IT) == SPI_I2S_IT_OVR))
/**
  * @}
  */
