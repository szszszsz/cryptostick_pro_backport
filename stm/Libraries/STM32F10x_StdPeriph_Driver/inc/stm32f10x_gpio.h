...
#define IS_GPIO_ALL_PERIPH(PERIPH)                                                                 \
  (((*(uint32_t *)&(PERIPH)) == GPIOA_BASE) || ((*(uint32_t *)&(PERIPH)) == GPIOB_BASE) ||         \
   ((*(uint32_t *)&(PERIPH)) == GPIOC_BASE) || ((*(uint32_t *)&(PERIPH)) == GPIOD_BASE) ||         \
...
#define IS_GPIO_SPEED(SPEED)                                                                       \
  (((SPEED) == GPIO_Speed_10MHz) || ((SPEED) == GPIO_Speed_2MHz) || ((SPEED) == GPIO_Speed_50MHz))
...
#define GPIO_Remap_TIM5CH4_LSI                                                                     \
  ((uint32_t)0x00200001) /* LSI connected to TIM5 Channel4 input capture for calibration */
#define GPIO_Remap_ADC1_ETRGINJ                                                                    \
  ((uint32_t)0x00200002) /* ADC1 External Trigger Injected Conversion remapping */
...
#define GPIO_Remap_ADC2_ETRGINJ                                                                    \
  ((uint32_t)0x00200008) /* ADC2 External Trigger Injected Conversion remapping */
...
#define GPIO_Remap_SWJ_NoJTRST                                                                     \
  ((uint32_t)0x00300100) /* Full SWJ Enabled (JTAG-DP + SW-DP) but without JTRST */
...
#define IS_GPIO_EXTI_PORT_SOURCE(PORTSOURCE)                                                       \
  (((PORTSOURCE) == GPIO_PortSourceGPIOA) || ((PORTSOURCE) == GPIO_PortSourceGPIOB) ||             \
   ((PORTSOURCE) == GPIO_PortSourceGPIOC) || ((PORTSOURCE) == GPIO_PortSourceGPIOD) ||             \
   ((PORTSOURCE) == GPIO_PortSourceGPIOE) || ((PORTSOURCE) == GPIO_PortSourceGPIOF) ||             \
