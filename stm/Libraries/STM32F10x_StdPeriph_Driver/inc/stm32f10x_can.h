...
#define IS_CAN_FLAG(FLAG)                                                                          \
  (((FLAG) == CAN_FLAG_EWG) || ((FLAG) == CAN_FLAG_EPV) || ((FLAG) == CAN_FLAG_BOF))
...
#define IS_CAN_ITConfig(IT)                                                                        \
  (((IT) == CAN_IT_TME) || ((IT) == CAN_IT_FMP0) || ((IT) == CAN_IT_FF0) ||                        \
   ...
   ((IT) == CAN_IT_BOF) || ((IT) == CAN_IT_LEC) || ((IT) == CAN_IT_ERR) || ((IT) == CAN_IT_WKU) || \
   ((IT) == CAN_IT_SLK))

#define IS_CAN_ITStatus(IT)                                                                        \
  (((IT) == CAN_IT_RQCP0) || ((IT) == CAN_IT_RQCP1) || ((IT) == CAN_IT_RQCP2) ||                   \
   ((IT) == CAN_IT_FF0) || ((IT) == CAN_IT_FOV0) || ((IT) == CAN_IT_FF1) ||                        \
   ((IT) == CAN_IT_FOV1) || ((IT) == CAN_IT_EWG) || ((IT) == CAN_IT_EPV) ||                        \
   ((IT) == CAN_IT_BOF) || ((IT) == CAN_IT_WKU) || ((IT) == CAN_IT_SLK))
/**
  * @}
  */
