...
#define IS_USART_ALL_PERIPH(PERIPH)                                                                \
  (((*(uint32_t *)&(PERIPH)) == USART1_BASE) || ((*(uint32_t *)&(PERIPH)) == USART2_BASE) ||       \
   ((*(uint32_t *)&(PERIPH)) == USART3_BASE) || ((*(uint32_t *)&(PERIPH)) == UART4_BASE) ||        \
...
#define IS_USART_HARDWARE_FLOW_CONTROL(CONTROL)                                                    \
  (((CONTROL) == USART_HardwareFlowControl_None) ||                                                \
   ((CONTROL) == USART_HardwareFlowControl_RTS) || ((CONTROL) == USART_HardwareFlowControl_CTS) || \
...
#define IS_USART_CONFIG_IT(IT)                                                                     \
  (((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || ((IT) == USART_IT_TC) ||                     \
   ((IT) == USART_IT_RXNE) || ((IT) == USART_IT_IDLE) || ((IT) == USART_IT_LBD) ||                 \
   ((IT) == USART_IT_CTS) || ((IT) == USART_IT_ERR))
#define IS_USART_GET_IT(IT)                                                                        \
  (((IT) == USART_IT_PE) || ((IT) == USART_IT_TXE) || ((IT) == USART_IT_TC) ||                     \
   ((IT) == USART_IT_RXNE) || ((IT) == USART_IT_IDLE) || ((IT) == USART_IT_LBD) ||                 \
   ((IT) == USART_IT_CTS) || ((IT) == USART_IT_ORE) || ((IT) == USART_IT_NE) ||                    \
   ((IT) == USART_IT_FE))
#define IS_USART_CLEAR_IT(IT)                                                                      \
  (((IT) == USART_IT_TC) || ((IT) == USART_IT_RXNE) || ((IT) == USART_IT_LBD) ||                   \
   ((IT) == USART_IT_CTS))
...
#define IS_USART_FLAG(FLAG)                                                                        \
  (((FLAG) == USART_FLAG_PE) || ((FLAG) == USART_FLAG_TXE) || ((FLAG) == USART_FLAG_TC) ||         \
   ((FLAG) == USART_FLAG_RXNE) || ((FLAG) == USART_FLAG_IDLE) || ((FLAG) == USART_FLAG_LBD) ||     \
   ((FLAG) == USART_FLAG_CTS) || ((FLAG) == USART_FLAG_ORE) || ((FLAG) == USART_FLAG_NE) ||        \
   ((FLAG) == USART_FLAG_FE))
