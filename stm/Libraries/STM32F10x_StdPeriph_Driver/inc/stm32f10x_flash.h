...
#define IS_FLASH_HALFCYCLEACCESS_STATE(STATE)                                                      \
  (((STATE) == FLASH_HalfCycleAccess_Enable) || ((STATE) == FLASH_HalfCycleAccess_Disable))
/**
  * @}
  */
...
#define IS_FLASH_GET_FLAG(FLAG)                                                                    \
  (((FLAG) == FLASH_FLAG_BSY) || ((FLAG) == FLASH_FLAG_EOP) || ((FLAG) == FLASH_FLAG_PGERR) ||     \
   ((FLAG) == FLASH_FLAG_WRPRTERR) || ((FLAG) == FLASH_FLAG_OPTERR))
