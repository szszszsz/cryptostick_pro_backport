...
/* Configure SDIO dtat pin8, pin9, pin10 and pin11 as output push-pull */
  ...
  n = 0;
	...
	{
		n++;
		if (n & 1) GPIO_SetBits(GPIOC, GPIO_Pin_8);  else GPIO_ResetBits(GPIOC, GPIO_Pin_8);
		if (n & 2) GPIO_SetBits(GPIOC, GPIO_Pin_9);  else GPIO_ResetBits(GPIOC, GPIO_Pin_9);
		if (n & 4) GPIO_SetBits(GPIOC, GPIO_Pin_10); else GPIO_ResetBits(GPIOC, GPIO_Pin_10);
		if (n & 8) GPIO_SetBits(GPIOC, GPIO_Pin_11); else GPIO_ResetBits(GPIOC, GPIO_Pin_11);
