...
/****************************************************************/
void CRD_Init(void) { CrdFlags = 0x00; }
 ...
 */
/****************************************************************/
unsigned char CRD_GetClockStatus(void) { return (CRD_CLOCKRUNNING); }
 ...
 */
/****************************************************************/
void CRD_StartWaitingTime(void) { Reset_bWaitingTimeFlag; }
 ...
 */
/****************************************************************/
void CRD_CharRepeatOff(void) { Reset_bParityErrorFlag; }
 ...
 */
/****************************************************************/
unsigned int CRD_EndReceive(void) { return CrdNbData; }
...
/****************************************************************/
unsigned int CRD_NumberOfBytesToTransmit(void) { return CrdNbData; }
 ...
 */
/****************************************************************/
unsigned int CRD_EndTransmit(void) { return CrdNbData; }
 ...
 */
/****************************************************************/
unsigned char ICC_SendCommandAsync(unsigned char *pTransmitBuffer, unsigned int CommandSize,
