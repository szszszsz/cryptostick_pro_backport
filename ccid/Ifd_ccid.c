...
unsigned char PC_to_RDR_IccPowerOff(void) {
  /*
          ...
          if(UsbMessageBuffer[OFFSET_DWLENGTH] != 0 || UsbMessageBuffer[OFFSET_DWLENGTH+1] != 0
                  || UsbMessageBuffer[OFFSET_DWLENGTH+2] != 0 || UsbMessageBuffer[OFFSET_DWLENGTH+3]
     != 0)
                  return SLOTERROR_BAD_LENTGH;
...
unsigned char PC_to_RDR_XfrBlock(void) {
  ...
  BlockSize = MAKEWORD(UsbMessageBuffer[OFFSET_DWLENGTH + 1], UsbMessageBuffer[OFFSET_DWLENGTH]);
...
unsigned char PC_to_RDR_SetParameters(void) {
  ...
  if (UsbMessageBuffer[OFFSET_DWLENGTH + 1] != 0 || UsbMessageBuffer[OFFSET_DWLENGTH + 2] != 0 ||
      UsbMessageBuffer[OFFSET_DWLENGTH + 3] != 0 ||
      ((UsbMessageBuffer[OFFSET_DWLENGTH] != 0x05) && (UsbMessageBuffer[OFFSET_DWLENGTH] != 0x07)))
    return SLOTERROR_BAD_LENTGH;
  ...
  if ((UsbMessageBuffer[OFFSET_DWLENGTH] == 0x07) &&
    ...
    //		UsbMessageBuffer[OFFSET_BPROTOCOLNUM_OUT] = 0x01;						 // Set to
    //T1
  ...
  //	ErrorCode = IFD_SetParameters(&UsbMessageBuffer[OFFSET_ABDATA],
  //UsbMessageBuffer[OFFSET_BPROTOCOLNUM_OUT]);
...
void RDR_to_PC_Parameters(unsigned char ErrorCode) {
  ...
  UsbMessageBuffer[OFFSET_BPROTOCOLNUM_IN] = IFD_GetParameters(&UsbMessageBuffer[OFFSET_ABDATA]);
